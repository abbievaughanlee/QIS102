#!/usr/bin/env python3
# ppl who can't riffle shuffle a deck of cards often spread out the cards on the table and stir them up in what is called a wash shuffle
...
#broken in half, shuffled around.. Array slicing!
...
def main():
    random.seed(2016)
    # function pointer.. wash shuffle does not depend on score shuffle: curried function
