...
def main():
    ...
    real, imag = np.meshgrid(real, imag) # grid of real and imaginary points (plotting is to be done in complex plane)
    
    c = np.vectorize(complex)(real, imag) # array of complex numbers to be plotted by using the real and imaginary parts
    z = f(c)
