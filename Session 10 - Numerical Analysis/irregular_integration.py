...
# scipy has a cumulative simpson function that uses an adaptive algorithm that can handle numerically estimating a quadrature even if the input domain is irregularly spaced
